    ...
    <div className="fixed top-0 w-full z-50 flex justify-center px-4 pt-4 pointer-events-none">
      ...
      >
        ...
        <a href="#home" onClick={(e) => scrollToSection(e, 'home')} className="group flex items-center gap-3">
          <div className="w-9 h-9 bg-linear-to-br from-blue-650 to-emerald-550/90 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg group-hover:rotate-12 transition-transform duration-300">
            H
          </div>
        ...
        <div className="hidden md:flex items-center gap-4">
          {/* Toggle Bahasa */}
          <div className="flex bg-slate-950/80 rounded-full p-1 border border-slate-800 pointer-events-auto">
            <button
              onClick={() => setLang('ID')}
        ...
        {isOpen && (
          ...
          >
            <div className="px-6 py-6 flex flex-col gap-4">
              ...
              <div className="flex bg-slate-950 rounded-xl p-1 border border-slate-800 w-fit self-center mb-2">
                <button
                  onClick={() => setLang('ID')}
                  className={`px-4 py-2 text-xs font-bold rounded-lg transition-all cursor-pointer ${
                    lang === 'ID' ? 'bg-blue-600 text-white shadow' : 'text-slate-400'
                  }`}
                >
                  ID (Bahasa)
                </button>
                <button
                  onClick={() => setLang('EN')}
                  className={`px-4 py-2 text-xs font-bold rounded-lg transition-all cursor-pointer ${
                    lang === 'EN' ? 'bg-blue-600 text-white shadow' : 'text-slate-400'
                  }`}
                >
                  EN (English)
                </button>
