...
export default function Projects() {
  ...
  const projects = [
    {
      id: 1,
      title: "Sistem Surat Perintah Lembur (SPL)",
      desc: "Sistem otomasi lembur terintegrasi dengan fitur Digital Signature berbasis QR Code. Dikembangkan menggunakan pendekatan Agile dan Laravel untuk efisiensi birokrasi perusahaan.",
    ...
    },
    {
      "id": 2,
  "title": "Medipluse",
  "desc": "Proyek tugas akhir kelompok untuk program MSIB Batch 7 di Rakamin Academy sebagai Full Stack Developer. Aplikasi ini dirancang untuk mendigitalisasi dan mengintegrasikan manajemen layanan kesehatan pribadi pengingat jam minum obat.",
  ...
  "liveLink": "#"
    ...
    },
    {
      ...
      desc: "Membangun arsitektur backend yang tangguh untuk melayani berbagai endpoint aplikasi mobile dan web client dengan tingkat keamanan tinggi.",
    ...
    },
    {
      ...
      desc: "Portofolio interaktif yang dibangun dengan animasi modern untuk memamerkan perjalanan karir dan keahlian teknis.",
            ...
            >
              ...
              <div className="relative overflow-hidden aspect-[4/3] border-b border-slate-800">
                ...
                <div className="absolute inset-0 bg-slate-950/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
                  ...
                  <a href={project.liveLink} className="p-3 bg-slate-800 hover:bg-emerald-500 rounded-full text-white transition-all transform translate-y-4 group-hover:translate-y-0 duration-300 delay-75 shadow-lg" title="Live Preview">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                  </a>
                </div>
              </div>
